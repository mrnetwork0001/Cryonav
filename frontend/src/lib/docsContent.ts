...
export const DOCS: Section[] = [
  {
    ...
    "blocks": [
      ...
      {
        "kind": "p",
        "text": "Every navigation app optimises metres and minutes. A weather feed sampled at 2 m above ground is nearly useless for separating a bare asphalt arterial from a shaded one, because the well-mixed air layer looks similar over both; the radiant load streaming off the surface does not. Here are two Phoenix locations 1,250 m apart, at the same moment, 15:00 local, as shown on the Cryonav landing page."
      },
      {
        "kind": "live-contrast",
      ...
      {
        "kind": "p",
        "text": "Measured across twelve demo corridors and three profiles - 36 combinations, 15:00 local, over all four tiles - by scripts/bench/corridor_sweep.py, which drives the deployed API and prints the table so it can be regenerated rather than remembered. On the 2026-08-27 calibration, thermal routing alone gave thermal load reduction 0.0 to 3.4 °F, heat-stress reduction 0.0 to 11.4 %, heat-strain dose reduction 0.0 to 10.1 %, shade coverage gained -0.2 to +35.0 %, added walking time -1.1 to +2.6 min. Permitting the Sentinel to insert a refuge widens that to -0.5 to 4.7 °F of load and as far as -30.8 % of dose and +47.9 min of time, because a mandated stop trades total dose and total minutes for a shorter longest-UNBROKEN high-risk leg. The original brief asked for a 35-50 % exposure reduction; Cryonav does not reach that on its headline metrics and does not round up to it. The zeroes are deliberate - ten of the 36 combinations return the direct path unchanged rather than manufacturing a detour, because on those the direct path already is the coolest admissible one."
      },
      {
        "kind": "h2",
